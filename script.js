...
let couponLinks = {
  "MS500": {
    plan3: "https://rzp.io/rzp/BcSmBHX",
    plan2: "https://rzp.io/rzp/yqGspxi"
  },
  "PS10": {
    plan3: "https://rzp.io/rzp/BcSmBHX",
    plan2: "https://rzp.io/rzp/AzefUwL"
  },
  "PS500": {
    plan3: "https://rzp.io/rzp/BcSmBHX",
    plan2: "https://rzp.io/rzp/AzefUwL"
  ...
  "KS500": {
    plan3: "https://rzp.io/rzp/0wI0XTX",
    plan2: "https://rzp.io/rzp/qBvLQh08"
  },
  "SD500": {
    plan3: "https://rzp.io/rzp/kS0jsovP",
    plan2: "https://rzp.io/rzp/NkIo0G5"
  },
  "VK500": {
    plan3: "https://rzp.io/rzp/FWlEZkB",
    plan2: "https://rzp.io/rzp/wWddD9Ds"
  },
};
...
function Click () {
  if (plan2) {
    plan2.addEventListener('click', () => {
      ...
      if (input === null || input.trim() === "") {
        // Cancel or empty input: open default plan2 link
  ...
  if (plan3) {
    plan3.addEventListener('click', () => {
      let input = prompt("Enter your coupon code:");
      if (input === null || input.trim() === "") {
        // Cancel or empty input: open default plan3 link
